...
def validate_data(values):
    """
    Inside the try, convert all string values into integer.
    Raise ValueError if the string cannot be converted into integer,
    or if there aren't exactly 6 integers.
    """
    try:
...
def update_surplus_worksheet(data):
    ...
    print("surplus worksheet aupdated successfully...\n")
...
def calculate_surplus_data(sales_row):
    ...
    - negetive surplus indicates extra made when stock was sold out
    """
